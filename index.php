...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Fitzy Home Page">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="ts-slider owl-carousel">
                        ...
                        ?>
                                    <div class="col-lg-4">
                                        <div class="ts-item set-bg" data-setbg="<?php if (!empty($Photo1)) { echo "data:image/jpg;charset=utf8;base64," . base64_encode($Photo1); } else { echo "img/team/team-1.jpg"; } ?>">
                                            <div class="ts_text">
                                                <h4><?php echo $Name1 ?></h4>
                                                <span>Fitzy Dietician</span>
                                            </div>
                                        </div>
                                    </div>
                        <?php
