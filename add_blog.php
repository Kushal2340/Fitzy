...
<head>
    ...
    <meta name="description" content="Fitzy Add Post">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="title_img">
                    <label for="file" class="up1">
                        <i class="fa fa-cloud-upload"></i> Upload Cover Image<br><span class="small">(1920x1080 recommended)</span>
                    </label>
                ...
                <div class="img1">
                    <label for="img1" class="up2">
                        ...
                        Upload Image 1<br><span class="small">(720x720 recommended)</span>
                    </label>
                ...
                <div class="img2">
                    <label for="img2" class="up2">
                        <i class="fa fa-cloud-upload"></i>
                        Upload Image 2<br><span class="small">(720x720 recommended)</span>
                    </label>
