...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Fitzy Contact Us">
    <meta name="keywords" content="Gym, unica, creative, html">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Fitzy | Contact Us</title>
    ...
    if (isset($_POST['sbt_btn'])) {
        ...
        $sql = "INSERT INTO `contact_us`(`Id`, `User_Id`, `Email_Id`, `Name`, `Contact_No`, `Message`) VALUES (NULL,'$user_id','$email','$name','$number','$message')";
