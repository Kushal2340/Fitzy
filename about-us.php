...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Fitzy About Us">
    <meta name="keywords" content="Gym, unica, creative, html">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Fitzy | About Us</title>
            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="about-video set-bg" data-setbg="img/about-us.jpg">
                        <a href="https://www.youtube.com/watch?v=oX6I6vs1EFs" class="play-btn video-popup"><i class="fa fa-caret-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-6 p-0">
                    <div class="about-text">
                        ...
                        <div class="at-desc">
                            <p>”Fitzy” is a Health and wellness-based Web
                                application.
                                Users can work on their health by performing
                                exercises to get fit, follow a diet by
                                encouraging healthy eating habits, improve
                                focus by meditating, track their daily
                                activities.
                                Users just need to choose a level of
                                complexity and a set of exercises they
                                prefer. 3D models, videos, or just detailed
                                descriptions explain how to perform each
                                workout.</p>
                        </div>
