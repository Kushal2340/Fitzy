...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Fitzy Edit Profile">
...
<body>
    ...
    if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
        ...
        $sql4 = "SELECT Username FROM user_master WHERE User_Id = $user_id";
        $query4 = mysqli_query($conn, $sql4);
        if ($query4) {
            $result4 = mysqli_fetch_array($query4);
            $row4 = $result4['Username'];
        }
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex flex-column align-items-center text-center">
                                                        <img src="<?php if (!empty($profile)) {
                                                                    ...
                                                                    } ?>" alt="Admin" class="rounded-circle bg-primary" width="150">
                                                        <div class="mt-3">
                                                            <h4><?= $name ?></h4>
                                                            </br>
                                                                    ...
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                                                        ...
                                                                        <span class="text-secondary" class="form-control">
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control" id="basic-url" name="youtube" placeholder="channel_link" value="<?= $row['Youtube'] ?>" aria-describedby="basic-addon3">
                                                                            </div>
                                                                        </span>
                                                                    </li>
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                                                    ...
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                                                        ...
                                                                        <span class="text-secondary" class="form-control">
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control" id="basic-url" value="<?= $row['Facebook'] ?>" name="facebook" placeholder="profile_link" aria-describedby="basic-addon3">
                                                                            </div>
                                                                        </span>
                                                                    </li>
                                                                </ul>
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 text-secondary">
                                                            <input type="text" name="email" class="form-control" value="<?= $row4 ?>" readonly>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                    <div class="row">
                    ...
                    if (isset($_POST['update'])) {
                        ...
                        if (empty($filename)) {
                            ...
                            if ($query && $query1) {
                                ...
                                echo '<b><script>swal("Profile Not Updated!", "Please try again leter' . $sql . '---' . $sql1 . '", "error");</script></b>';
                            }
