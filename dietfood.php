...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Fitzy Diet Food">
...
<body>
    ...
    if (isset($_GET['diet_id']) && isset($_GET['type'])) {
        ...
        $mysql = "SELECT * FROM `dietfood_routine` WHERE `Customer_Id`='$customer_id' && `Type`='$type'";
        $myquery = mysqli_query($conn, $mysql);
        if ($myquery) {
            if(mysqli_num_rows($myquery) < 7) {
                $sql1 = "SELECT * FROM `dietfood_routine` WHERE `Customer_Id`='$customer_id' && `Dietfood_Id`='$diet_id' && `Type`='$type'";
                $query1 = mysqli_query($conn, $sql1);
                if ($query1) {
                    if(mysqli_num_rows($query1) > 0) {
                        echo '<b><script>if (swal("Dietfood already exists in '.$text.'", "", "error")) {setTimeout(function () { window.location.href="dietfood.php?category='.$category.'"; }, 2000); }</script></b>';
                    } else {
                        $sql = "INSERT INTO `dietfood_routine`(`Dietfood_Routine_Id`, `Customer_Id`, `Dietfood_Id`, `Time`, `Sent`, `Type`) VALUES (NULL,'$customer_id','$diet_id','00:00:00', '0', '$type')";
                        $query = mysqli_query($conn, $sql);
                ...
                echo '<b><script>if (swal("Dietfood Limit of 7 Exceeded For '.$text.'", "", "error")) {setTimeout(function () { window.location.href="dietfood.php?category='.$category.'"; }, 2000); }</script></b>';
            }
        }
    }
?>
                        ...
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <div class="dropdown show">
                                    <a class="btn btn-primary" href="" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Add to routine</a>

                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item" href="<?php echo "./dietfood.php?diet_id=".$Dietfood_Id."&category=".$category."&type=breakfast"; ?>">Breakfast</a>
                                        <a class="dropdown-item" href="<?php echo "./dietfood.php?diet_id=".$Dietfood_Id."&category=".$category."&type=preworkout"; ?>">Pre-workout</a>
                                        <a class="dropdown-item" href="<?php echo "./dietfood.php?diet_id=".$Dietfood_Id."&category=".$category."&type=postworkout"; ?>">Post-workout</a>
                                        <a class="dropdown-item" href="<?php echo "./dietfood.php?diet_id=".$Dietfood_Id."&category=".$category."&type=lunch"; ?>">Lunch</a>
                                        <a class="dropdown-item" href="<?php echo "./dietfood.php?diet_id=".$Dietfood_Id."&category=".$category."&type=dinner"; ?>">Dinner</a>
                                    </div>
                                </div>
                                            <?php
                                        }
