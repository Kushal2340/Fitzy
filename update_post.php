...
<head>
    ...
    <meta name="description" content="Fitzy Update Post">
...
<body>
            ...
            if(empty($filename)) {
                ...
                if ($source_width >= 1536) {
                    if (round($source_width / $source_height, 2) == 1.78 || round($source_width / $source_height, 2) == 2.13) {
                        ...
                        $imgResized = imagescale($image, 1920, 1080);
    ...
    ?>
        <div class="text-center title">Update Post</div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="title_img">
                    <label for="file" class="up1">
                        <i class="fa fa-cloud-upload"></i> Update Cover Image<br><span class="small">(1920x1080 recommended)</span>
                    </label>
                ...
                <div class="img1">
                    <label for="img1" class="up2">
                        ...
                        Update Image 1<br><span class="small">(720x720 recommended)</span>
                    </label>
                ...
                <div class="img2">
                    <label for="img2" class="up2">
                        <i class="fa fa-cloud-upload"></i>
                        Update Image 2<br><span class="small">(720x720 recommended)</span>
                    </label>
