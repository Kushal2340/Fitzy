...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Fitzy Payment Success
                    ...
                    if ($row) {
                        ...
                        if (mysqli_num_rows($query) > 0) {
                            ...
                            if (mysqli_num_rows($query8) > 0) {
                                ...
                                $sql2 = "INSERT INTO `membership`(`Membership_Id`, `Customer_Id`, `tx_no`, `Package_Id`, `Trainer_Id`, `Dietician_Id`, `Status`, `Start_Date`, `Start_Time`, `End_Date`, `End_Time`) VALUES (NULL,'$Customer_Id','$t_id','$planid','$trainer[$random_key1]','$dietician[$random_key2]','$sta','$start_date','$start_time','$end_date','$end_time')";
                                $query2 = mysqli_query($conn, $sql2);
                        ...
                        if ($status == "succeeded") {
                            ...
                            if (!$mail->send()) {
                                ...
                                $mail1->Password = 'Fitzy@123456789f';
                                ...
                                $mail1->Body = ' <table width="500px" align="center" border="0" style="background-color: #FFFFFF;"><tr> <th style="font-size: 28px; padding: 30px; text-align: center;">Hello, ' . $name . '</th> </tr> <tr> <td style="font-size: 18px; padding: 10px; text-align: justify;">Your Membership has been activated successfully! You can check info on your profile.</td> </tr> <tr> <td style="font-size: 18px; padding: 10px; text-align: justify;">We have assigned a trainer and dietician for you!</td> </tr> <tr> <td style="font-size: 18px; padding: 10px; font-weight: bold; text-align: left;">Your Trainer is: ' . $row6['Name'] . '</td> </tr> <tr> <td style="font-size: 18px; padding: 10px; font-weight: bold; text-align: left;">Your Trainer Contact No is: ' . $row6['Contact_No'] . '</td> </tr> <tr> <td style="font-size: 18px; padding: 10px; font-weight: bold; text-align: left;">Your Dietician is: ' . $row7['Name'] . '</td> </tr> <tr> <td style="font-size: 18px; padding: 10px; font-weight: bold; text-align: left;">Your Dietician Contact No is: ' . $row7['Contact_No'] . '</td> </tr> <tr> <td style="font-size: 18px; padding: 10px;">Thank You,<br>Fitzy</td> </tr> </table>';
                                $mail1->send();
                            }
                        } else {
